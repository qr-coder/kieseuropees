...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    category: "Circulair",
    url: "https://www.awin1.com/cread.php?awinmid=105845&awinaffid=2778796&ued=https%3A%2F%2Fwww.otrium.nl%2Fmerken%2Fmud-jeans%2Fdames",
  ...
  },
  {
    ...
    country: "Zweden",
    flag: "🇸🇪",
    description: "Filippa K is een Zweeds modemerk dat tijdloos Scandinavisch design combineert met duurzaamheid. Het merk staat bekend om minimalistische, hoogwaardige kleding die seizoen na seizoen meegaat.",
    longDescription: "Filippa K werd in 1993 opgericht door Filippa Knutsson in Stockholm met een duidelijke visie: minder maar betere stukken creëren. Het merk was een van de pioniers van de 'less is more'-filosofie in de mode, lang voordat duurzaamheid een trend werd.\n\nDe collecties van Filippa K worden gekenmerkt door strakke lijnen, neutrale kleurpaletten en een tijdloze esthetiek die verder gaat dan seizoensgebonden trends. Elk kledingstuk is ontworpen om jarenlang mee te gaan, zowel qua stijl als kwaliteit.\n\nFilippa K zet zich actief in voor een circulaire mode-industrie. Het merk heeft een eigen tweedehands platform, Filippa K Preowned, en werkt aan het verkleinen van de ecologische voetafdruk in elke stap van het productieproces. Van het gebruik van duurzame materialen tot transparante toeleveringsketens — Filippa K bewijst dat stijl en verantwoordelijkheid hand in hand gaan.",
    category: "Premium kleding",
    url: "https://www.awin1.com/cread.php?awinmid=105845&awinaffid=2778796&ued=https%3A%2F%2Fwww.otrium.nl%2Fmerken%2Ffilippa-k%2Fdames",
    homepageUrl: "https://www.filippa-k.com",
    founded: "1993",
    headquarters: "Stockholm, Zweden",
  ...
  },
  {
    ...
    country: "Duitsland",
    flag: "🇩🇪",
    description: "IRIEDAILY is een Berlijns streetwearmerk dat casual kleding maakt met een sterke focus op eerlijke productie, vegan materialen en langdurige kwaliteit.",
    longDescription: "IRIEDAILY werd in 1994 opgericht in Berlijn en groeide uit tot een herkenbaar Europees streetwearmerk met een duidelijke sociale en duurzame missie. Het merk maakt alledaagse kleding zoals T-shirts, hoodies, jassen en broeken voor mensen die comfort, stijl en verantwoordelijkheid willen combineren.\n\nDe collecties zijn volledig veganistisch en IRIEDAILY is lid van de Fair Wear Foundation. Het merk werkt stap voor stap aan betere materialen, transparantere productieketens en eerlijke arbeidsomstandigheden bij de productiepartners.\n\nMet zijn Berlijnse achtergrond staat IRIEDAILY voor onafhankelijke cultuur, skate- en streetwearinvloeden en kleding die lang meegaat. Het merk laat zien dat toegankelijke streetwear ook bewust geproduceerd kan worden.",
    category: "Streetwear",
    url: "https://www.iriedaily.de",
    homepageUrl: "https://www.iriedaily.de",
    founded: "1994",
    headquarters: "Berlijn, Duitsland",
    highlights: ["Veganistische streetwear", "Fair Wear Foundation lid", "Berlijns merk sinds 1994"],
    clothingTypes: ["T-shirts", "Truien & Sweaters", "Broeken & Jeans", "Jassen"],
    priceLevel: 2,
  },
  {
    ...
    country: "Italië",
    flag: "🇮🇹",
    description: "ID.EIGHT is een Italiaans vegan sneakermerk dat innovatieve reststromen en gerecyclede materialen gebruikt voor kleurrijke, duurzame schoenen.",
    longDescription: "ID.EIGHT werd opgericht in Italië met het doel om sneakers te maken die stijlvol, diervriendelijk en minder belastend voor de planeet zijn. Het merk staat bekend om het gebruik van innovatieve materialen uit reststromen, zoals druiven-, appel- en maïsresten, gecombineerd met gerecyclede componenten.\n\nDe sneakers worden ontworpen en geproduceerd in Italië, met aandacht voor vakmanschap, comfort en transparantie. Door plantaardige en gerecyclede materialen te gebruiken biedt ID.EIGHT een alternatief voor conventioneel leer en synthetische sneakers.\n\nID.EIGHT combineert Italiaans design met een speelse, moderne uitstraling. Het merk richt zich op mensen die bewuste keuzes willen maken zonder in te leveren op kleur, karakter en draagbaarheid.",
    category: "Schoenen",
    url: "https://www.id-eight.com",
    homepageUrl: "https://www.id-eight.com",
    founded: "2020",
    headquarters: "Italië",
    highlights: ["Vegan sneakers Made in Italy", "Materialen uit druiven-, appel- en maïsresten", "Gerecyclede en innovatieve componenten"],
    clothingTypes: ["Schoenen"],
    priceLevel: 2,
  },
  {
  ...
  },
  {
    ...
    country: "Zweden",
    flag: "🇸🇪",
    description: "Didriksons is een Zweeds merk dat al meer dan 100 jaar staat voor functionele, waterdichte kleding. Het merk maakt duurzame jassen, regenkleding en outdoor kleding voor het hele gezin, met een sterke focus op kwaliteit en bescherming tegen het Scandinavische weer.",
    longDescription: "Didriksons werd in 1913 opgericht door Julius en Hanna Didrikson in Grundsund, Zweden. Wat begon als een kleine productie van oliejassen voor vissers is uitgegroeid tot een van Scandinavië's meest vertrouwde merken voor functionele outdoor kleding.\n\nHet merk staat bekend om hun uitstekende waterdichte en ademende materialen die zijn ontworpen om de Scandinavische elementen te weerstaan. Didriksons combineert klassieke functionaliteit met moderne duurzaamheidsinspanningen, waaronder het gebruik van gerecyclede materialen, PFC-vrije waterafstotende coatings en een focus op lange productlevensduur.\n\nDidriksons ontwerpt kleding voor het hele gezin — van kinderen tot volwassenen — en legt de nadruk op tijdloos design dat jarenlang meegaat. Het merk volgt het Scandinavische principe dat goede kleding je moet beschermen tegen alle weersomstandigheden, ongeacht wat je doet of waar je bent.",
    category: "Outdoor",
    url: "https://www.awin1.com/cread.php?awinmid=8333&awinaffid=2778796&ued=https%3A%2F%2Fwww.suitableshop.nl%2Fdidriksons%2F",
    homepageUrl: "https://www.didriksons.com",
    founded: "1913",
    headquarters: "Grundsund, Zweden",
    highlights: ["100+ jaar Zweeds vakmanschap", "PFC-vrije waterafstotende coatings", "Gerecyclede materialen en lange levensduur"],
    clothingTypes: ["Jassen", "Broeken & Jeans", "Zwemkleding"],
    priceLevel: 2,
  },
  {
    name: "Nudie Jeans",
    ...
    country: "Zweden",
    flag: "🇸🇪",
    description: "Nudie Jeans is een Zweeds denimmerk dat bekendstaat om zijn 100% biologische katoenen jeans en het iconische gratis reparatieprogramma. Het merk combineert premium Zweedse denim met een onwrikbaar engagement voor eerlijke productie en volledige transparantie in de keten.",
    longDescription: "Nudie Jeans werd in 2001 opgericht in Göteborg, Zweden, door Maria Erixon. Het merk groeide uit tot een van 's werelds meest vooraanstaande duurzame denimmerken, met een filosofie die draait om respect voor het ambacht en de mensen achter de productie.\n\nAlle Nudie Jeans zijn gemaakt van 100% biologisch katoen, en het merk was een van de eersten die volledig overschakelden op Fair Trade-gecertificeerd katoen. Nudie staat voor radicale transparantie: op hun website is precies te zien waar elke stof vandaan komt en welke fabrieken bij de productie zijn betrokken.\n\nHet meest iconische onderdeel van Nudie is het gratis reparatieprogramma. Klanten kunnen overal ter wereld hun jeans laten repareren in Nudie Repair Shops, waardoor de levensduur wordt verlengd en textielafval wordt tegengegaan. Worn-out jeans die niet meer gerepareerd kunnen worden, worden gerecycled tot nieuwe stof. Het merk streeft naar volledige circulariteit in de denim-industrie.",
    category: "Denim",
    url: "https://www.nudiejeans.com",
    homepageUrl: "https://www.nudiejeans.com",
    founded: "2001",
    headquarters: "Göteborg, Zweden",
    highlights: ["100% biologisch katoen en Fair Trade", "Gratis reparatieprogramma wereldwijd", "Volledige transparantie in productieketen"],
    clothingTypes: ["Broeken & Jeans", "T-shirts", "Overhemden", "Jassen"],
    priceLevel: 2,
  },
  {
    name: "Asket",
    ...
    country: "Zweden",
    flag: "🇸🇪",
    description: "Asket is een Zweeds merk dat de ultieme basics maakt door alle seizoenscollecties af te schaffen en in plaats daarvan één permanent assortiment van hoogwaardige essentials te bouwen. Het merk is radicaal transparant over de totale prijsopbouw en CO2-impact van elk kledingstuk.",
    longDescription: "Asket werd in 2015 opgericht in Stockholm door August Bard-Bringéus en Jakob Dworsky. Frustrated by the endless cycle of seasonal fashion, besloten ze het hele collectiemodel op zijn kop te zetten: geen seizoenen, geen trends, alleen één permanente collectie van perfecte basics die continu worden verbeterd.\n\nHet merk staat bekend om zijn extreme transparantie. Bij elk product toont Asket de exacte kosten van materialen, productie, transport, verpakking en marge — en de totale CO2-voetafdruk. Deze radicale openheid zorgt ervoor dat klanten weten wat ze betalen en welke impact hun kleding heeft.\n\nAsket produceert in Portugal, Italië en Oekraïne met gecertificeerde fabrieken en gebruikt uitsluitend biologisch katoen, gerecycled wol en andere duurzame materialen. Hun "Impact Receipt" toont niet alleen wat een product kostte om te maken, maar ook wat het milieu heeft gekost — en hoeveel je bespaart vergeleken met conventionele mode.",
    category: "Basics",
    url: "https://www.asket.com",
    homepageUrl: "https://www.asket.com",
    founded: "2015",
    headquarters: "Stockholm, Zweden",
    highlights: ["One permanent collection zonder seizoenen", "Radicale transparantie over prijs en CO2", "Gecertificeerde productie in Europa"],
    clothingTypes: ["T-shirts", "Truien & Sweaters", "Overhemden", "Broeken & Jeans", "Jassen"],
    priceLevel: 2,
  },
];
